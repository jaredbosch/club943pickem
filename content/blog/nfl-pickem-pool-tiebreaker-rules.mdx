...
Guesses stay sealed until Monday night kickoff. Once the game starts, The Grid for that week shows an MNF TB column with every player's guess next to the running total, and once the game is final the closest guess is marked — so anyone can confirm who won the tiebreaker without a group text.
