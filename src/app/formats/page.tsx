...
const FORMATS = [
  {
    ...
    desc: "Pick every NFL game against the spread and assign a unique confidence number (1–16) to each pick. Stack high confidence on your locks, low confidence on coin flips. Points earned = confidence × correct, and a push pays half your confidence when the league has Push = half points on. The best handicappers rise to the top over 18 weeks.",
    details: [
      { label: "Picks per week", value: "All games" },
      { label: "Scoring", value: "Confidence 1–16 per game" },
      { label: "Push", value: "½ your confidence (commissioner can set 0)" },
  ...
  },
  {
    ...
    desc: "Pick the outright winner of every game — no point spread. Assign confidence 1–16 exactly like ATS Confidence, so skill differentiation stays high. A tie game pays half your confidence when the league has Push = half points on. Great for groups where not everyone follows the betting market.",
    details: [
      { label: "Picks per week", value: "All games" },
      { label: "Scoring", value: "Confidence 1–16 per game" },
      { label: "Push", value: "½ your confidence (commissioner can set 0)" },
...
const COMPARISON = [
  ...
  { feature: "Push scoring",       ats_confidence: "½ conf. or 0", su_confidence: "½ conf. or 0", ats: "0 pts", straight_up: "0 pts", pick5_ats: "½ pt", pick5_su: "½ pt" },
